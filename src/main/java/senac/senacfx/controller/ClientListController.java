...
public abstract class ClientListController implements Initializable, DataChangeListener {
    ...
    @FXML
    private TableView<Department> tableViewClientList;
    ...
    public ClientListController(Button btNewClient) {
        this.btNewClient = btNewClient;
    }
    ...
    private void initializeNodes() {
        ...
        tableViewClientList.prefHeightProperty().bind(stage.heightProperty());
    ...
    public void updateTableView(){
        ...
        tableViewClientList.setItems(obsList);
        initEditButtons();
        initRemoveButtons();
    }
            ...
            protected void updateItem(Department obj, boolean empty) {
                ...
                button.setOnAction(
                        event -> createDialogForm(
                                obj, "/gui/ClientForm.fxml",Utils.currentStage(event)));
            }
        });
    }
